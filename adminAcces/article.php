			...
			<div class="card text-center" class="articleAffichage" style="width: 50%; margin-right: auto; margin-left: auto; margin-top: 30px;">
 			...
 			<div class="card-body">
    			...
    			<p class="card-text"><?php echo $contenu ;?> 
    				...
    				<a href="editionArticle.php?id=<?php echo $get_id ;?>" class="btn btn-primary">Modifier cet article</a>&nbsp; <a href="suppressionArticle.php?id=<?php echo $get_id ?>" class="btn btn-primary">Supprimer cet article</a>
    			</p>
  			</div>
